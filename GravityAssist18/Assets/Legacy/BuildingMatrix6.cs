...
//// holes not allowed
//[RequireComponent(typeof(GPUFaceInstancer))]
...
//    public int res = 10;
//    public int heightRes = 2;

    
//    GPUFaceInstancer faceInstancer;

//    void Awake()
//    {
//        faceInstancer = GetComponent<GPUFaceInstancer>();
//        map = new float[res, heightRes, res];
//    }

//    public void UpdateRangeHeight(Vector2Int xRange, int heightindex, Vector2Int zRange, float newHeight)
//    {
//        for (int x = xRange.x; x < xRange.y; x++)
//        {
//                for (int z = zRange.x; z < zRange.y; z++)
//                {
//                    if (IsInRange(x, heightindex, z))
//                    {
//                        map[x, heightindex, z] = newHeight;
//                    }
//                }
...
//        {
//            for (int y = heightindex - 1; y < heightindex + 1; y++)
//            {
