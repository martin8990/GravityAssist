...
public partial class Contexts : Entitas.IContexts {
    ...
    public UniverseContext universe { get; set; }

    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { universe }; } }

    public Contexts() {
        universe = new UniverseContext();
...
public partial class Contexts {
    ...
    public void InitializeContexObservers() {
        try {
            CreateContextObserver(universe);
